...
public class SerializationManager : MonoBehaviour
{
    ...
    public void SaveDataAsCSV()
    {
        ...
        using (StreamWriter streamWriter = new StreamWriter(savePath))
        {
            ...
            {
                string data = sim.simName + ',' + sim.age + ',' + sim.simColour.r + ',' + sim.simColour.g + ',' + sim.simColour.b + ',' + sim.simColour.a;
    ...
    public void LoadDataAsCSV()
    {
        if (savePath == "") return; //no file path to load from

        string csv = string.Empty; //initialise the string
        ...
        using (StreamReader streamReader = new StreamReader(savePath))
        {
            ...
            {
                //we know each line is one SimData object as a csv string
